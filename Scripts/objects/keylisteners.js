...
(function (objects) {
    ...
    var GameKeyListener = (function () {
        ...
        GameKeyListener.prototype.createFixtureDefinition = function () {
        ...
        GameKeyListener.prototype.createBodyDefinition = function () {
        ...
        GameKeyListener.prototype.createButton = function () {
            // Add Hero to world
        ...
        GameKeyListener.prototype.assignControls = function () {
            // Binds key actions
            window.onkeyup = this.onControlUp;
        };
        GameKeyListener.prototype.onControlUp = function (e) {
            switch (e.which) {
                case keys.SPACEBAR:
    ...
    objects.GameKeyListener = GameKeyListener;
})(objects || (objects = {}));
//# sourceMappingURL=keylisteners.js.map