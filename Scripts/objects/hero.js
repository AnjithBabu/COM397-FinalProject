...
(function (objects) {
    var Hero = (function () {
        ...
        // create fire bullet that hero fires
        Hero.prototype.createFireBall = function () {
            if (controls.firing) {
                this.fireball = new objects.Fire((this.body.GetPosition().x * config.SCALE) - 20, (this.body.GetPosition().y * config.SCALE));
                createjs.Sound.play("herofire"); // call firing sound
        ...
        // returns the current position of hero , used for firing bullets
        Hero.prototype.getHeroPosition = function () {
            return new createjs.Point((this.body.GetPosition().x * config.SCALE) - 20, (this.body.GetPosition().y * config.SCALE));
        };
        // plays animation and sound when hero gets hit
        Hero.prototype.heroGotHit = function () {
            this.view.gotoAndPlay("heroDizzy");
            createjs.Sound.play("hurt");
        };
        Hero.prototype.heroGotPoint = function () {
