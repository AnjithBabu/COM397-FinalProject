...
(function (states) {
    var GamePlayLevelTwo = (function () {
        function GamePlayLevelTwo() {
            ...
            this.enemy = new objects.SpaceShip("assets/images/spaceshipblack.png", true);
            this.game.addChild(this.enemy);
            stage.addChild(this.game);
            // credit hero some lives for reaching level two
            config.HERO_LIVES += 4;
        ...
        GamePlayLevelTwo.prototype.update = function () {
            ...
            if (this.levelTwoCleared) {
                this.game.removeAllChildren();
                stage.removeChild(this.game);
                stage.removeAllChildren();
                currentState = config.MENU_STATE_3;
                stateChanged = true;
        ...
        GamePlayLevelTwo.prototype.checkCollision = function (fireObj, countValue, fireballs) {
        ...
        GamePlayLevelTwo.prototype.checkCollisionEnemy = function (enemyFireObj, countValue, fireballs) {
            ...
            var theDistance = this.distance(planePosition, objectPosition);
            if (theDistance < ((97 * 0.5) + (enemyFireObj.height * 0.5))) {
                // hero.heroGotHit();
        ...
        GamePlayLevelTwo.prototype.checkCollisionPackage = function (packageObj, countValue, packages) {
            var planePosition = this.hero.getHeroPosition();
    ...
    states.GamePlayLevelTwo = GamePlayLevelTwo;
})(states || (states = {}));
//# sourceMappingURL=gameplay_lvl_2.js.map