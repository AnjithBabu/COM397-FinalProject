...
var ground;
var fireballCount;
var enemyFireBallCount;
var bonusPackageCount;
// Physics Variables
var world;
var reality;
// Game Objects
...
var fireballs = [];
var enemyFireBalls = [];
var bonusFirePackages = [];
var fireballObj;
var enemy;
var enemyFireBall;
var bonusFirePackage;
function preload() {
...
function checkCollision(fireObj, countValue, fireballs) {
    var planePosition = hero.getHeroPosition();
...
function checkCollisionEnemy(enemyFireObj, countValue, fireballs) {
    var planePosition = new createjs.Point(enemy.x, enemy.y);
...
function checkCollisionPackage(packageObj, countValue, packages) {
    var planePosition = hero.getHeroPosition();
